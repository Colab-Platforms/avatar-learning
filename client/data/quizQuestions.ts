...
export const QUIZ_QUESTIONS: QuizQuestion[] = [
    ...
    options: [
      {
        ...
        desc: "Coding, apps, AI and gadgets",
        icon: "💻",
        scores: { TC: 5, ED: 3 },
      },
      {
        label: "Business & Management",
        desc: "Planning, strategy and leading teams",
        icon: "📊",
        scores: { BM: 5, MC: 2 },
      },
      {
        label: "Healthcare & Helping others",
        desc: "Improving people's health and lives",
        icon: "🏥",
        scores: { HS: 5, CD: 1 },
      },
      {
        label: "Creative & Design",
        desc: "Art, visuals, content and storytelling",
        icon: "🎨",
        scores: { CD: 5, MC: 2 },
      },
      {
        label: "Engineering & Building things",
        desc: "Making, fixing and building systems",
        icon: "🔧",
        scores: { ED: 5, TC: 2 },
      },
      {
        label: "Marketing & Communication",
        desc: "Promoting ideas and talking to people",
        icon: "📣",
        scores: { MC: 5, BM: 2 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "Watching tech videos or tutorials",
        icon: "📱",
        scores: { TC: 3, ED: 2 },
      },
      {
        label: "Reading about business or money",
        icon: "📈",
        scores: { BM: 3, MC: 1 },
      },
      {
        label: "Helping or volunteering for others",
        icon: "🤝",
        scores: { HS: 3, CD: 1 },
      },
      {
        label: "Drawing, designing or making things",
        icon: "✏️",
        scores: { CD: 3, MC: 2 },
      },
      {
        label: "Building or fixing things by hand",
        icon: "🔨",
        scores: { ED: 3, TC: 2 },
      },
      {
        label: "Creating content, reels or writing",
        icon: "🎬",
        scores: { MC: 3, CD: 2 },
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        label: "Art, Design & Literature",
        icon: "🖌️",
        scores: { CD: 4, MC: 2 },
      },
      { label: "Physics & Engineering", icon: "⚙️", scores: { ED: 4, TC: 2 } },
      {
        label: "Marketing, Media & Social Studies",
        icon: "🌍",
        scores: { MC: 4, BM: 1 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "A tech startup or big tech company",
        icon: "🚀",
        scores: { TC: 3, ED: 2 },
      },
      {
        label: "A corporate office or consulting firm",
        icon: "🏦",
        scores: { BM: 3, MC: 1 },
      },
      {
        label: "A hospital, clinic or health brand",
        icon: "💊",
        scores: { HS: 3 },
      },
      {
        label: "A design studio or media agency",
        icon: "🎭",
        scores: { CD: 3, MC: 2 },
      },
      {
        label: "A factory, lab or engineering firm",
        icon: "🏭",
        scores: { ED: 3, TC: 1 },
      },
      {
        label: "My own business or freelancing",
        icon: "💼",
        scores: { MC: 3, CD: 2 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "Search online for how others solved it",
        icon: "🔍",
        scores: { TC: 4, ED: 2 },
      },
      {
        label: "Make a plan or list of steps",
        icon: "📋",
        scores: { BM: 4, MC: 2 },
      },
      {
        label: "Talk to someone who knows more",
        icon: "💬",
        scores: { HS: 4, CD: 1 },
      },
      {
        label: "Sketch ideas or brainstorm on paper",
        icon: "📝",
        scores: { CD: 4, MC: 2 },
      },
      {
        label: "Just try something and see what happens",
        icon: "⚡",
        scores: { ED: 4, TC: 2 },
      },
      {
        label: "Look at the numbers or data first",
        icon: "📊",
        scores: { MC: 3, BM: 3 },
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        label: "Convincing and communicating ideas",
        icon: "🗣️",
        scores: { BM: 3, MC: 4 },
      },
      {
        label: "Listening and understanding people",
        icon: "👂",
        scores: { HS: 4, CD: 2 },
      },
      {
        label: "Creative and visual thinking",
        icon: "🎨",
        scores: { CD: 4, MC: 2 },
      },
      {
        label: "Technical and hands-on building",
        icon: "🔧",
        scores: { ED: 4, TC: 2 },
      },
      {
        label: "Research and spotting trends",
        icon: "📉",
        scores: { MC: 3, BM: 3 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "The one who builds or codes things",
        icon: "💻",
        scores: { TC: 5, ED: 2 },
      },
      {
        label: "The leader who organises the team",
        icon: "👑",
        scores: { BM: 5, MC: 2 },
      },
      {
        label: "The one who keeps everyone together",
        icon: "🤝",
        scores: { HS: 4, CD: 2 },
      },
      {
        label: "The one who makes it look great",
        icon: "✨",
        scores: { CD: 5, MC: 2 },
      },
      {
        label: "The one who actually builds the product",
        icon: "🏗️",
        scores: { ED: 5, TC: 2 },
      },
      {
        label: "The one who pitches and presents it",
        icon: "🎤",
        scores: { MC: 5, BM: 2 },
      },
    ],
  },
  {
    ...
    emoji: "⏰",
    title:
      "Which of these could you happily do for hours without getting bored?",
    sub: "Pick all that apply",
    multi: true,
    options: [
      {
        label: "Coding or exploring AI tools",
        icon: "🤖",
        scores: { TC: 4, ED: 2 },
      },
      {
        label: "Reading about business trends",
        icon: "📰",
        scores: { BM: 3, MC: 2 },
      },
      { label: "Caring for or advising people", icon: "🧘", scores: { HS: 4 } },
      {
        label: "Creating graphics, videos or content",
        icon: "🖼️",
        scores: { CD: 4, MC: 3 },
      },
      {
        label: "Assembling, fixing or building things",
        icon: "🛠️",
        scores: { ED: 4, TC: 2 },
      },
      {
        label: "Running campaigns and growing pages",
        icon: "📲",
        scores: { MC: 4, CD: 1 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "Working at a top tech company",
        icon: "🚀",
        scores: { TC: 4, ED: 2 },
      },
      {
      ...
      {
        label: "Making a real difference in health",
        icon: "❤️",
        scores: { HS: 4 },
      },
      {
        label: "Being a well-known creative",
        icon: "🌈",
        scores: { CD: 4, MC: 2 },
      },
      {
        label: "Building products used by millions",
        icon: "🏆",
        scores: { ED: 4, TC: 2 },
      },
      {
        label: "Being a recognised voice in my field",
        icon: "📢",
        scores: { MC: 4, BM: 1 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "Solving hard problems and learning",
        icon: "🧠",
        scores: { TC: 4, ED: 3 },
      },
      {
      ...
      {
        label: "Making a positive impact on people",
        icon: "🌿",
        scores: { HS: 4, CD: 1 },
      },
      { label: "Freedom to be creative", icon: "🎭", scores: { CD: 4, MC: 2 } },
      {
        label: "Building real things that actually work",
        icon: "⚙️",
        scores: { ED: 4, TC: 2 },
      },
      {
        label: "Building a personal brand online",
        icon: "🌐",
        scores: { MC: 4, BM: 1 },
      },
    ],
...
export const ROLES: Role[] = [
  ...
  },
  {
    ...
    courses: [
      {
        name: "Business Fundamentals for Freshers",
        level: "Starter",
        icon: "📋",
      },
      { name: "AI for Business Leaders", level: "Intermediate", icon: "🧠" },
      {
        name: "Financial Modelling & Analytics",
        level: "Intermediate",
        icon: "📈",
      },
    ],
  },
  {
    ...
    roadmap: [
      ...
      "Manager",
      "Director of Healthcare AI",
    ],
    courses: [
      { name: "Introduction to Health Tech", level: "Starter", icon: "💊" },
      {
        name: "AI in Healthcare Certification",
        level: "Intermediate",
        icon: "🩺",
      },
  ...
  },
  {
    ...
    courses: [
      ...
      {
        name: "AI Design Tools Certification",
        level: "Intermediate",
        icon: "🖥️",
      },
      {
  ...
  },
  {
    ...
    courses: [
      {
        name: "Engineering Fundamentals with AI",
        level: "Starter",
        icon: "🔧",
      },
      {
        name: "Automation & Robotics Certification",
        level: "Intermediate",
        icon: "🤖",
      },
...
export function computeResult(answers: Record<number, string[]>): {
  ...
  for (const q of QUIZ_QUESTIONS) {
    ...
    for (const label of selected) {
      ...
      if (!opt) continue;
      for (const [key, val] of Object.entries(opt.scores) as [
        DomainKey,
        number,
      ][]) {
        totals[key] += val;
  ...
  const sorted = (Object.entries(totals) as [DomainKey, number][]).sort(
    (a, b) => b[1] - a[1],
  );
  ...
  const matchPct = Math.min(
    98,
    Math.round((sorted[0][1] / maxPossible) * 100) + 40,
  );
  const secondPct = Math.min(
    95,
    Math.round((sorted[1][1] / maxPossible) * 100) + 30,
  );

...
export const BLOG_ARTICLES: BlogArticle[] = [
  {
    ...
    title:
      "Best AI Courses for Beginners: How to Choose the Right One for Your Career",
    hoverDescription:
...
Start with the right AI skill. Then build from there.`,
  ...
  },
  {
    ...
    title:
      "The AI Practitioner Framework: Why Guided Learning Beats Recorded Videos",
    hoverDescription:
...
This bridge between theoretical knowledge and professional delivery is why Avatar's partner network actively seeks out Direct2Hire graduates.`,
  ...
  },
  {
    ...
    title:
      "Don't Try to Learn Every AI Tool: How to Focus on What Actually Matters",
    hoverDescription:

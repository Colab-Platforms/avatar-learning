              ...
              >
                ...
                <Field label="Week Title" required className="sm:col-span-2">
                  <input
                    ...
                    placeholder="Week 1: Introduction to Generative AI"
                    className={inputCls}
                    required
                  />
                </Field>
                <Field label="Description" className="sm:col-span-2">
                  <textarea
                    ...
                    rows={2}
                    placeholder="What will students cover this week?"
                    className={`${inputCls} resize-none`}
                  />
                </Field>
                ...
                <Field
                  label="Lesson Topics (modules)"
                  className="sm:col-span-2"
                >
                  <ModuleListEditor
                    modules={lessonForm.modules}
                    onChange={(mods) =>
                      setLessonForm((f) => ({ ...f, modules: mods }))
                    }
                  />
                </Field>
            ...
            <div className="divide-y divide-white/4">
              {sortedLessons.map((lesson) => (
                <WeekRow
                  ...
                  onToggleExpand={() =>
                    setExpandedWeek(
                      expandedWeek === lesson.id ? null : lesson.id,
                    )
                  }

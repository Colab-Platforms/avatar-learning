...
import {
  Phone, Mail, MapPin, Send, Check, X, Loader2,
...
const CONTACT_INFO = [
  {
    ...
    hoverBg: "group-hover:bg-brand-500/20 group-hover:border-brand-500/35 group-hover:shadow-[0_0_14px_rgba(0,200,255,0.15)]",
  },
  {
    icon: Mail,
    label: "Email Us",
    ...
    hoverBg: "group-hover:bg-elec-500/20 group-hover:border-elec-500/35 group-hover:shadow-[0_0_14px_rgba(0,128,255,0.15)]",
  },
  {
    icon: MapPin,
    label: "Our Office",
    ...
    hoverBg: "group-hover:bg-emerald-500/20 group-hover:border-emerald-500/35 group-hover:shadow-[0_0_14px_rgba(16,185,129,0.15)]",
  },
];

const SOCIAL_LINKS = [
  { label: "Facebook",  href: "https://www.facebook.com/share/1JpYwqS4jQ/",  bg: "bg-[#1877f2] hover:bg-[#1465d0]",
    svg: <svg viewBox="0 0 24 24" className="h-3.5 w-3.5" fill="currentColor"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg> },
  { label: "Instagram", href: "https://www.instagram.com/avatar.india/",
    bg: "bg-gradient-to-br from-purple-600 via-pink-500 to-rose-400 hover:opacity-90",
    svg: <svg viewBox="0 0 24 24" className="h-3.5 w-3.5" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg> },
  { label: "YouTube",   href: "https://www.youtube.com/@AvatarIndia-g1i", bg: "bg-[#ff0000] hover:bg-[#cc0000]",
    svg: <svg viewBox="0 0 24 24" className="h-3.5 w-3.5" fill="currentColor"><path d="M22.54 6.42a2.78 2.78 0 0 0-1.95-1.96C18.88 4 12 4 12 4s-6.88 0-8.59.46A2.78 2.78 0 0 0 1.46 6.42 29 29 0 0 0 1 12a29 29 0 0 0 .46 5.58 2.78 2.78 0 0 0 1.95 1.96C5.12 20 12 20 12 20s6.88 0 8.59-.46a2.78 2.78 0 0 0 1.96-1.96A29 29 0 0 0 23 12a29 29 0 0 0-.46-5.58z"/><polygon points="9.75 15.02 15.5 12 9.75 8.98 9.75 15.02" fill="#fff"/></svg> },
  { label: "LinkedIn",  href: "#", bg: "bg-[#0077b5] hover:bg-[#005e8f]",
    svg: <svg viewBox="0 0 24 24" className="h-3.5 w-3.5" fill="currentColor"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-4 0v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg> },
];
                ...
                <AnimateOnScroll key={info.label} delay={i * 70}>
                  ...
                  >
                    ...
                    {info.href ? (
                      <Link
                        href={info.href}
                        className={cn("text-[14px] font-semibold text-white/80 hover:text-white transition-colors duration-200 block")}
                      >
                        {info.value}
                      </Link>
                    ) : (
                      <p className="text-[14px] font-semibold text-white/80">{info.value}</p>
                    )}
          ...
          <div className="mt-10 grid lg:grid-cols-[1fr_340px] gap-6 items-start">
            ...
            <ScrollReveal animation="fade-up" delay={120}>
              ...
              >
                ...
                <div className="flex items-center gap-3 px-6 py-4 border-b border-white/5">
                  ...
                  <div>
                    <h2 className="text-[15px] font-semibold text-white">Send a Message</h2>
                    <p className="text-[11px] text-white/30 mt-0.5">We typically respond within 24 hours</p>
                  </div>
                </div>
            ...
            <ScrollReveal animation="fade-left" delay={160}>
              <div className="space-y-4">
                ...
                >
                  <h3 className="text-[15px] font-semibold text-white mb-1.5">Get In Touch</h3>
                    ...
                    {CONTACT_INFO.map((info) => (
                      <div key={info.label} className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                          <p className="text-[10px] text-white/28 uppercase tracking-wider">{info.label}</p>
                          {info.href ? (
                            <Link href={info.href}
                            ...
                            <p className="text-[13px] text-white/65">{info.value}</p>
                          )}
                        </div>
                      </div>
                    ))}
                ...
                <div
                  className="rounded-2xl border border-white/7 p-6"
                  style={{ background: "linear-gradient(145deg,rgba(9,21,37,0.92) 0%,rgba(6,13,26,0.97) 100%)" }}
                >
                  <h3 className="text-[14px] font-semibold text-white mb-4">Follow Us</h3>
                ...
                <div
                  ...
                  style={{
                    background: "linear-gradient(145deg,rgba(0,200,255,0.04) 0%,rgba(6,13,26,0.97) 100%)",
                    boxShadow: "0 0 30px rgba(0,200,255,0.05)",
                  }}
                >
                  <div className="absolute top-0 inset-x-0 h-px"
                    style={{ background: "linear-gradient(90deg,transparent,rgba(0,200,255,0.4) 50%,transparent)" }} />

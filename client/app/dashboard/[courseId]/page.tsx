...
function D2HOverview() {
  ...
  const heroPrimaryAction = useMemo(() => {
    if (!hasAssessment) {
      return { label: "Start Assessment", href: `/dashboard/${courseId}/assessment` };
    }
    if (!hasCounselling) {
      return { label: "Book Counselling", href: `/dashboard/${courseId}/counselling` };
    }
    if (!hasFullAccess) {
      return {
    ...
    if (!hasInternship) {
      return {
        ...
        href: `/dashboard/${courseId}/internships`,
      };
    }
    if (!hasPlacementAssessment) {
      return {
    ...
    return { label: "View Placement Panel", href: `/dashboard/${courseId}/placement` };
  }, [
    hasAssessment,
    hasCounselling,
    hasFullAccess,
          ...
          {hasInternship ? (
            <>
              ...
              <Link
                href={
                  hasPlacementAssessment
                    ? `/dashboard/${courseId}/placement/mock-interview`
                    : `/dashboard/${courseId}/placement`
                }

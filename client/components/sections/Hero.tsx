...
const CARDS = [
  {
    title: "NSE-Listed organization",
    description:
      "Build future-ready AI skills with the trust, credibility, and expertise of an NSE-listed organization.",
    icon: Building2,
  },
  {
    title: "Structured AI Courses",
    description:
      "No coding background needed. Learn with structured lessons, projects, and real examples.",
    icon: GraduationCap,
  },
  {
    title: "Exclusive AI Community",
    description:
      "Join community groups to connect with industry expert, mentors, get job alerts, and network fast.",
    icon: Users,
  },
  {
    title: "Career Support",
    description:
      "Accelerate your career with live projects, internship offers,interview preparation and placement guidance.",
    icon: Briefcase,
  },
];
...
export function Hero() {
  return (
    <section className="relative bg-white pt-6 pb-20 overflow-hidden">
      ...
      <div className="mx-4 md:mx-6 lg:mx-8 bg-gradient-to-br from-brand-50/50 via-white to-brand-100/50 rounded-[32px] pt-10 pb-44 px-6 md:px-16 relative overflow-hidden flex flex-col items-start border border-brand-100/60 shadow-[0_8px_30px_rgba(0,0,0,0.04)]">
        {/* Glow Effects */}
        ...
        <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <div className="max-w-2xl">
            ...
            <p className="mt-6 max-w-xl text-lg text-slate-600 leading-relaxed anim-fade-up stagger-2">
              ...
              <span className="font-semibold">Avatar</span> is India's

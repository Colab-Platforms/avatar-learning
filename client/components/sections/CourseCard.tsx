      ...
      <div className="relative p-6 sm:p-8 grid gap-8 md:grid-cols-[1fr_2fr]">
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-auto pt-8 flex items-center gap-3">
            ...
            <button className="group/lnk inline-flex items-center gap-1 text-sm font-medium text-white/40 hover:text-brand-400 transition-colors duration-250">
              View details
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {course.modules.map((mod, i) => (
              ...
              >
                ...
                <p className="text-[11px] text-white/30 mt-0.5">{mod.session}</p>
              </div>
            ))}
          </div>
